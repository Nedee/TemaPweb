...
public class AlexController : ControllerBase // The controller must inherit ControllerBase or its derivations.
{
    ...
    /// </summary>
    public AlexController(IUserService userService) => _userService = userService;
    ...
    public async Task<ActionResult<RequestResponse<LoginResponseDTO>>> Logins([FromBody] LoginDTO login) // The FromBody attribute indicates that the parameter is deserialized from the JSON body.
    {
